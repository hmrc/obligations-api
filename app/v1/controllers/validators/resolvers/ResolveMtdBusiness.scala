...
object ResolveMtdBusiness extends ResolverSupport {
  val resolver: Resolver[String, MtdBusiness] = resolvePartialFunction(TypeOfBusinessFormatError)(MtdBusiness.parser)
}
