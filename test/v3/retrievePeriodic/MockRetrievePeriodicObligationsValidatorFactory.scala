...
trait MockRetrievePeriodicObligationsValidatorFactory extends MockValidatorFactory[RetrievePeriodicObligationsRequest] {

  val mockRetrievePeriodicObligationsValidatorFactory: RetrievePeriodicObligationsValidatorFactory =
