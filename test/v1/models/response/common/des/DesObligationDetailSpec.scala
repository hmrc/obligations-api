...
<<<<<<< HEAD:test/v1/models/response/retrievePeriodicObligations/des/DesObligationDetailSpec.scala
package v1.models.response.retrievePeriodicObligations.des
=======
package v1.models.response.common.des
>>>>>>> MTDSA-5237 Models for EOPS Obligations:test/v1/models/response/common/des/DesObligationDetailSpec.scala
