      ...
      "passed a model with status Fulfilled" in {
        val json = Json.parse(
          """
            ...
            |}
            |""".stripMargin)
        val model = Obligation("2018-04-06", "2019-04-05", "1920-01-31", MtdStatus.Fulfilled, Some("2020-01-25"))
      ...
      "passed a model with status Open" in {
        val json = Json.parse(
          """
            ...
            |}
            |""".stripMargin)
        val model = Obligation("2018-04-06", "2019-04-05", "1920-01-31", MtdStatus.Open, Some("2020-01-25"))
      ...
      "passed a model with no receivedDate" in {
        val json = Json.parse(
          """
            ...
            |}
            |""".stripMargin)
        val model = Obligation("2018-04-06", "2019-04-05", "1920-01-31", MtdStatus.Open, None)
